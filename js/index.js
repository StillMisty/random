window.onload = function(){
  ...
  const move_distance = 430;
  
  let img_distance = -move_distance*(rotate_img.length);
  ...
  left.addEventListener("click",()=>{
    ...
    if(img_distance >= 0){
      ...
      img_distance = -move_distance*(rotate_img.length+1);
      img_exhibition.style.transform = `translateX(${img_distance}px)`;
    }
  })
  ...
  right.addEventListener("click",()=>{
    ...
    img_distance -= move_distance;
    img_exhibition.style.transform = `translateX(${img_distance}px)`;
    if(img_distance <= -move_distance*(rotate_img.length+3)){
      img_exhibition.style.transition = "none";
      img_distance = -move_distance*2;
      img_exhibition.style.transform = `translateX(${img_distance}px)`;
    }
  })
